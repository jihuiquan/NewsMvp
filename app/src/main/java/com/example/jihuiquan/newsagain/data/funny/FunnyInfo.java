package com.example.jihuiquan.newsagain.data.funny;
...
public class FunnyInfo {
    ...
    public static FunnyInfo objectFromData(String str) {

        return new Gson().fromJson(str, FunnyInfo.class);
    }


    public static List<FunnyInfo> arrayFunnyPicBeanFromData(String str) {

        Type listType = new TypeToken<ArrayList<FunnyInfo>>() {
        }.getType();
